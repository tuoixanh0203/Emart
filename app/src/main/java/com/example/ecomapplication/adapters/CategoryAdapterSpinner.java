...
public class CategoryAdapterSpinner extends ArrayAdapter<Category> {
    public CategoryAdapterSpinner(@NonNull Context context, int resource, @NonNull List<Category> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_category_selected_spinner, parent, false);
